...
config :another_tracking_tool, AnotherTrackingToolWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AnotherTrackingToolWeb.ErrorHTML, json: AnotherTrackingToolWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: AnotherTrackingTool.PubSub,
  live_view: [signing_salt: "qVeYtpXI"]
