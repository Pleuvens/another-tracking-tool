defmodule AnotherTrackingTool.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      AnotherTrackingToolWeb.Endpoint
    ]

    # See https://elixir.hexdocs.pm/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: AnotherTrackingTool.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    AnotherTrackingToolWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
