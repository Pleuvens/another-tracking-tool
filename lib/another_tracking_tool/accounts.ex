defmodule AnotherTrackingTool.Accounts do
  @moduledoc """
  ...
  See `AnotherTrackingTool.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  def update_user_locale(user, attrs) do
    user |> User.locale_changeset(attrs) |> Repo.update()
  end
  ...
  See `AnotherTrackingTool.Accounts.User.password_changeset/3` for a list of supported options.
