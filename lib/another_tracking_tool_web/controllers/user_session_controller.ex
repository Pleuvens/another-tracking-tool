defmodule AnotherTrackingToolWeb.UserSessionController do
  ...
  def create(conn, %{"_action" => "confirmed"} = params) do
    create(conn, params, dgettext("accounts", "User confirmed successfully."))
  end
  ...
  defp create(conn, %{"user" => %{"token" => token} = user_params}, info) do
    case Accounts.login_user_by_magic_link(token) do
      ...
      _ ->
        conn
        |> put_flash(:error, dgettext("accounts", "The link is invalid or it has expired."))
